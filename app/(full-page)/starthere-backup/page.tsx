            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/" className="flex align-items-center">
                        ...
                        <span className="text-900 font-medium text-2xl line-height-3 mr-8">PEO Soldier</span>
                    </Link>
                    ...
                    <div id="nv"
                        ...
                        >
                            <div className="flex flex-wrap gap-2">
                                <div className="col-10 text-center mt-8 mb-4">
                ...
                >
                        ...
                        <div className="col-12 text-center mt-8 mb-4">
                            <h2 className="text-900 font-normal mb-2">Sign IT User Agreement</h2>                            
                            <Button onClick={()=> window.open(Pdf_aup, "_blank")} label="Open IT User Agreement" rounded severity="info" />
                        </div></div>
                </div>                
                <div id="dd2875"
                    className="col-12 mt-8 mb-8 p-2 md:p-8"
                ...
                >
                        ...
                        <div className="flex flex-wrap gap-2">
                        <div className="col-12 text-center mt-8 mb-4">
                            <h2 className="text-900 font-normal mb-2">System Access Request</h2>   
                            <Button onClick={()=> window.open(Pdf, "_blank")} label="Complete DD2875 SAAR" rounded severity="info" />
                        </div></div>
                </div>
